      ...
      <div className='px-4 flex items-center'>
        ...
        <Menu as='div' className='relative'>
          ...
          <Transition
            ...
            <Menu.Items className='absolute right-0 z-10 mt-2 w-64 origin-top-right rounded-xl bg-midnight py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
              <UserSubMenu />
            </Menu.Items>
          </Transition>
        </Menu>
