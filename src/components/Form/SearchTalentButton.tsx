...
function SearchTalentButton(props?: { value?: string }) {
  ...
  return (
    <form onSubmit={e => handleSubmit(e)}>
      <div className='flex  bg-white py-2 px-3 sm:px-0 justify-center items-center flex-row drop-shadow-lg rounded'>
        ...
        <div className='sm:px-4 flex flex-row  sm:space-x-4 justify-between items-center border-0'>
          <button
            type='submit'
