      ...
      <div className='bg-redpraha rounded-xl px-6 py-6'>
        <div className='flex w-full flex-col items-center sm:flex-row'>
          <div className='flex flex-1 flex-row w-full mb-4'>
            <div className='relative inline-flex shrink-0 items-center justify-center outline-none h-12 w-12 rounded-full border-primary-200/50 ring-primary-200/50 ring-offset-primary-600 border ring-2 ring-offset-4'>
            ...
            <h2 className='font-heading text-3xl font-bold leading-none text-white flex-1 ml-4 flex items-center'>
              My hive
            </h2>
          </div>
          <div className='flex w-full flex-1 flex-col'>
            ...
            <div className='mt-auto flex gap-2'>
              ...
              <button
                type='button'
                className='disabled:opacity-60 disabled:cursor-not-allowed hover:shadow-none false false border border-gray-300 text-white bg-gray-700 hover:bg-gray-600 border-gray-600 hover:bg-gray-50 rounded-xl h-10 w-10 p-2 relative inline-flex items-center justify-center space-x-1 font-sans text-sm font-normal leading-5 no-underline outline-none transition-all duration-300'>
                <PlusIcon />
              </button>
            </div>
          </div>
